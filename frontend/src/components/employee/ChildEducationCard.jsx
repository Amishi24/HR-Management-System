...
export default function ChildEducationCard({ dependents = [] }) {
    ...
    function handleLocalCreate(childId) {
        const localNewRecord = {
            ...
            curr_class: 1,
            academic_year: "",
            isNew: true, // Marker to indicate this needs addEducation instead of updateEducation
        };
    ...
    function handleLocalRemove(childId, isNewRecord) {
        if (!isNewRecord) {
                ...
                <div className="space-y-6">
                    <div className="space-y-4">
                        {childDependents.map((child) => {
                            ...
                            return (
                                <div key={child.id} className="border border-slate-200 rounded-2xl p-5">
                                    <div className="grid md:grid-cols-3 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                disabled={!edu}
                                                onChange={(e) =>
                                                    handleChange(child.id, "curr_class", e.target.value)
                                                }
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                disabled={!edu}
                                                onChange={(e) =>
                                                    handleChange(child.id, "academic_year", e.target.value)
                                                }
                                                className="w-full rounded-xl border border-slate-200 bg-slate-50 p-3 disabled:opacity-50"
                                            />
                                        </div>
                                    ...
                                    <div className="flex justify-end mt-5">
                                        {!edu ? (
                                            ...
                                            <button
                                                onClick={() => handleLocalRemove(child.id, edu.isNew)}
